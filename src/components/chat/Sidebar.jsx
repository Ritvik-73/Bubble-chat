  ...
  return (
    <div className="flex flex-col h-full w-1/3" style={{ background: '#30302e', borderRight: '0.5px solid #8f8e86' }}>
      ...
      <div className="px-4 py-3 shrink-0" style={{ borderTop: '0.5px solid #8f8e86' }}>
        <div className="flex items-center gap-3 rounded-lg px-3 py-2" style={{ background: '#272724', height: '41px' }}>
          <div className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-semibold text-white shrink-0" style={{ background: '#1D9E75' }}>
            {getInitials(user?.user_metadata?.username || user?.email)}
          </div>
          <div className="flex-1 min-w-0">
          ...
          <button onClick={handleLogout} className="text-xs hover:underline shrink-0" style={{ color: '#8f8e86' }}>
            Sign out
          </button>
        </div>
      </div>
